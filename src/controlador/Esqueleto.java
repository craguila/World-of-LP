...
public class Esqueleto extends Monstruo{
    ...
    public boolean actualizar(){
        ...
        if (direccion == 'n'){
            sprite = Sprite.EARRIBA0;
            if (enMovimiento){
                if (resto>10 && resto <= 20){
                    sprite = Sprite.EARRIBA1;
                } else if (resto>20 && resto<=30){
                    sprite= Sprite.EARRIBA0;
                } else if (resto>30 && resto<=40){
                    sprite= Sprite.EARRIBA2;
                } else{
                    sprite= Sprite.EARRIBA0;
                }
            }
        ...
        if (direccion == 's'){
            sprite = Sprite.EABAJO0;
             if (enMovimiento){
                if (resto>10 && resto <= 20){
                    sprite = Sprite.EABAJO1;
                } else if (resto>20 && resto<=30){
                    sprite= Sprite.EABAJO0;
                } else if (resto>30 && resto<=40){
                    sprite= Sprite.EABAJO2;
                } else{
                    sprite= Sprite.EABAJO0;
                }
            }
        ...
        if (direccion == 'o'){
            sprite = Sprite.EIZQUIERDA0;
             if (enMovimiento){
                if (resto>10 && resto <= 20){
                    sprite = Sprite.EIZQUIERDA1;
                } else if (resto>20 && resto<=30){
                    sprite= Sprite.EIZQUIERDA0;
                } else if (resto>30 && resto<=40){
                    sprite= Sprite.EIZQUIERDA2;
                } else{
                    sprite= Sprite.EIZQUIERDA0;
                }
            }
        ...
        if (direccion == 'e'){
            sprite = Sprite.EDERECHA0;
             if (enMovimiento){
                if (resto>10 && resto <= 20){
                    sprite = Sprite.EDERECHA1;
                } else if (resto>20 && resto<=30){
                    sprite= Sprite.EDERECHA0;
                } else if (resto>30 && resto<=40){
                    sprite= Sprite.EDERECHA2;
                } else{
                    sprite= Sprite.EDERECHA0;
                }
            }
